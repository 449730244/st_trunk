...
class SetDataController extends Controller
{
    ...
    public function SetLqSClass()
    {
        ...
        try{
            ...
            Log::info("新篮球赛事数据写入数据库成功\n");
        }catch (\Exception $exception){
            Log::info("新篮球赛事数据写入数据库失败：".$exception->getMessage());
        }
    }
